  ...
  <div class="import-page">
    ...
    <v-card variant="tonal" class="bg-surface-container mb-4 pa-4" rounded="xl">
      ...
      <v-textarea
        v-model="urlInput"
        label="每行一个 URL"
        placeholder="https://e-hentai.org/g/12345/abcdef/&#10;https://e-hentai.org/g/67890/ghijkl/"
        rows="5"
        auto-grow
        variant="outlined"
        :hint="`已输入 ${parsedUrls.length} 个 URL`"
        persistent-hint
      />
      ...
      <div class="d-flex ga-3 mt-4 flex-wrap">
        ...
        <v-btn
          ...
          :disabled="!tasksStore.submitResult"
          @click="goToTasks"
        >
          查看任务
        </v-btn>
    ...
    >
      ...
      <v-list variant="flat" rounded="lg" class="bg-surface-container-high">
        ...
        >
          <template #prepend>
            <v-icon
              :color="item.is_duplicate ? 'warning' : 'success'"
